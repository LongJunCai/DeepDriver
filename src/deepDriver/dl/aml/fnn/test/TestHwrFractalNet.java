package deepDriver.dl.aml.fnn.test;
...
public class TestHwrFractalNet {
...
//		
	...
	public static void main(String[] args) throws Exception {
		TestHwrFractalNet fnn = new TestHwrFractalNet();
		...
		dir.mkdirs();
		fnn.train(dir.getAbsolutePath()+"\\kaggleTest\\modelTrain", 
