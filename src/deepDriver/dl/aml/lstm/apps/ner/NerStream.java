...
public class NerStream implements IStream{

	NerDataLoader loader;
	Embedding embedding;
	...
	public NerStream(NerDataLoader loader, Embedding embedding){
		super();
		this.loader = loader;
	...
	public NerStream(NerDataLoader loader){
		super();
		this.loader = loader;
		this.embedding = null;
		this.factory = null;
